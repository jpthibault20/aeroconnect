...
const SessionPopup = ({ sessions, children, setSessions, usersProps, planesProp }: Prop) => {
    ...
    useEffect(() => {
        let updatedPlanes;
        const classroomPlane = { id: "classroomSession", name: "session théorique", immatriculation: "classroomSession", operational: true, clubID: currentUser?.clubID as string, classes: [1, 2, 3, 4, 5, 6] };
